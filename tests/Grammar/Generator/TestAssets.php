        ...
        public function testExpectations() : void {
            ...
            $generator =
                new \pharos\phathom\Grammar\Generator(
                    null, [
                        'token'   => '\\pharos\\phathom\\tests\\Grammar\\Token',
                        'context' => '\\pharos\\phathom\\tests\\Grammar\\File'
                    ], 
                    $lexer,
                    [], []);
            ...
            $this->assertTrue(\is_subclass_of($symbols[0][0], \pharos\phathom\tests\Grammar\Token::class));

            $this->assertTrue(\is_subclass_of($symbols[0][1], \pharos\phathom\Context::class));
            $this->assertTrue(\is_subclass_of($symbols[0][1], \pharos\phathom\tests\Grammar\File::class));
        }
    }
}